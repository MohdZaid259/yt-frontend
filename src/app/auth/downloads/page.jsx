...
export default function DownloadPage(){
  ...
  return (
    <div className="flex flex-col rounded-lg  md:flex-row mx-auto bg-black text-white min-h-screen">
    ...
    <div className="flex-1 w-full lg:w-[500px] p-4">
      <div className="flex justify-between items-center">
        <span className="font-semibold text-lg sm:text-xl">Downloaded Vidoes</span>
